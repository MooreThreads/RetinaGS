import torch
import math
from diff_gaussian_rasterization_metric import GaussianRasterizationSettings, GaussianRasterizer
...
def render_with_GradNormHelper(viewpoint_camera, pc, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None):
    """
    Render the scene. 
