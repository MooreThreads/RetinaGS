...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, depth, cnt, cnt2, alpha, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        return color, radii, depth, cnt, cnt2, alpha

    @staticmethod
    def backward(ctx, grad_color, grad_radii, grad_depth, grad_cnt, grad_cnt2, grad_alpha):
