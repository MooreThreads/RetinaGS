...
1. Download the testing scene and the corresponded pretrained model from [GoogleDrive](https://drive.google.com/drive/folders/1gRiMixAtCS7dZ5q2v_DGMXcHWggMfNRk?usp=drive_link) and place them in the root directory.
