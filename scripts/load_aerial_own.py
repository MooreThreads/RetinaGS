...
def load_street():
    AERIAL_BLOCK_NAME = "Block_all"
    
    os.makedirs(os.path.join('/root/Nerf/Data/MatrixCity/bdaibdai___MatrixCity/small_city/street/pose', AERIAL_BLOCK_NAME),exist_ok=True)
    ...
    save_dir = os.path.join('/root/Nerf/Data/MatrixCity/bdaibdai___MatrixCity/small_city/street/pose', AERIAL_BLOCK_NAME)
