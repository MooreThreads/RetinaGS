...
if __name__ == "__main__":
    ...
    parser.add_argument("--EVAL_INTERVAL_EPOCH", type=int, default=10000)
    parser.add_argument("--SAVE_INTERVAL_EPOCH", type=int, default=10000)
    parser.add_argument("--SAVE_INTERVAL_ITER", type=int, default=30000)
